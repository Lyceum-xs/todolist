...
graph TB
    subgraph Layout["📱 页面布局"]
        ...
        subgraph Content["主体内容区"]
            direction LR
            Sidebar["🧭 Sidebar<br/>侧边栏"]
            MainContent["📄 Main Content<br/>主内容区"]
        end
        ...
        ContentArea["📦 Content Area<br/>内容展示区域"]
    end
    ...
    class TaskMenu,HabitMenu,CalendarMenu,TimerMenu,SettingsMenu menuStyle
```

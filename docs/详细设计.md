...
block-beta
    ...
    classDef areaStyle fill:#ffffff,stroke:#374151,stroke-width:1px,color:#1f2937
    
    class Header headerStyle
    class Sidebar,TaskMenu,HabitMenu,CalendarMenu,TimerMenu,SettingsMenu sidebarStyle
    class MainContent contentStyle
    class ContentArea areaStyle
```
